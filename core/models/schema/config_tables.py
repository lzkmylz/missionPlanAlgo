    ...
    def __init__(self):
        super().__init__(
            ...
            columns=[
                ...
                ColumnDefinition("max_roll_angle", ColumnType.DECIMAL, precision=5, scale=2, comment="最大滚转角(度) - 绕X轴侧摆"),
                ColumnDefinition("max_pitch_angle", ColumnType.DECIMAL, precision=5, scale=2, comment="最大俯仰角(度) - 绕Y轴前后斜视"),
                # ColumnDefinition("max_off_nadir", ColumnType.DECIMAL, precision=5, scale=2, comment="[废弃]最大侧摆角(度),改用max_roll_angle"),
