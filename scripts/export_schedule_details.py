...
def run_fcfs_and_export(
    ...
    for task in tasks_to_export:
        ...
        imaging_record = {
            ...
            "power_before_wh": getattr(task, 'power_before', 0.0),
            "power_after_wh": getattr(task, 'power_after', 0.0),
            "power_consumed_wh": getattr(task, 'power_consumed', 0.0),
            "power_generated_wh": getattr(task, 'power_generated', 0.0),
            "energy_consumption_j": getattr(task, 'energy_consumption', 0.0),
            "battery_soc_before_pct": getattr(task, 'battery_soc_before', 0.0),
            "battery_soc_after_pct": getattr(task, 'battery_soc_after', 0.0),
